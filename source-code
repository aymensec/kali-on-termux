...
echo $CYAN "------------------------------------------------"
echo "  coded by aymen:ahmedin    tiktok.com/@aymensec"
echo $BLUE "------------------------------------------------"
...
rm $tarball
clear
echo "/data/data/com.termux/files/home/start-kali.sh" > kali
chmod +x kali
mv kali ../usr/bin
...
clear
echo " "
echo $GREEN[+]"type ( kali ) and run this script( bash gui.sh )"
